...
public class tutorial {
    ...
    public void ejemploLlamarUnaFuncion() {
        ...
        System.out.println(
            "la suma de " + valor1 + " y " + valor2 + " es: " + sumar
        );
    }
    ...
    public void ejemploCondiciones() {
        ...
        switch (x) {
            case 16 -> {
                System.out.println("x vale 16");
            } //si x vale 16
            case 18 -> {
                System.out.println("x vale 18");
            } //si x vale 18
    ...
    public static void ejemploBucles() {
        //bucle for
        for (int i = 0; i < 10; i++) {
            //en este ejemplo se lee asi: i = 0, i se ira incrementando en 1 hasta que sea menor que 10 y en cada iteracion, se ejecutara el codigo situado entre {}

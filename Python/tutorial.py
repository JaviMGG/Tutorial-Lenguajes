...
print(
    "Concatenacion de strings con espacio entre ellas: ", a + " " + b
)  # tambien se puede hacer si a = "hola "
print(
    "esta cadena larga para concaternar"
...
print(
    "caracteres fuera de los indices:", palabra[10:15]
)  # Esto no da error, devuelve una cadena vacía
...
print(
    "imprimir desde el segundo elemnto hasta el final:\n", array[2:]
)  # tambien se puede hacer array[-9:]
...
for i in range(
    1, 4
):  # tambien se puede sustituir range(1,4) por una lista o un array, en ese caso se recorre todo el array/lista
    print(i)
...
print(
    "imprimir los elementos desde 1 hasta 10 yendo de 2 en 2 (incremento)",
    list(range(1, 10, 2)),
)

print(
    "mostrar desde 0 hasta 10, NO MUESTRA LA LISTA, MUESTRA LA FUNCION QUE SE HACE, SI QUEREMOS MOSTRAR LA LISTA, TENEMOS QUE USAR list"
)
print(range(10))
